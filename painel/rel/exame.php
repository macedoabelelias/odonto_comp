...
<br>
		<table id="" style="border-style: solid; font-size: 9px; margin-bottom:10px; width: 100%; table-layout: fixed; margin-top:10px;">
			<thead>
    			...
    			<tr >
					...
					<td colspan="5" style="width:13%; border-bottom: : 1px solid #000;">
		...
		<div align="left" style="margin-top: 40px; margin-bottom: 10px; border-bottom: 1px solid #000; font-size:12px"><b>SOLICITAÇÃO DE EXAMES</b></div>
</div>
